...
class TestDb extends Db {
  ...
  def reset {
    ...
    transaction {
      ...
      artifacts.insert( Artifact.create(ioi.id, "a1", T.ago(600000000), T.now, 1024L * 1024 * 1024 * 15) )
      artifacts.insert( Artifact.create(ioi.id, "a2", T.ago(900000000), T.now, 1024L * 1024 * 1024 * 15) )
      artifacts.insert( Artifact.create(ioi.id, "a3", T.ago(700000000), T.now, 1024L * 1024 * 1024 * 15) )
      artifacts.insert( Artifact.create(ioi.id, "a4", T.ago(200000000), T.now, 1024L * 1024 * 1024 * 15) )
    }
  }
